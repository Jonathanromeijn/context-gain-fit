...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Loadline — AI strength coach & workout tracker" },
      {
        name: "description",
        content:
          "Loadline logs your lifts and coaches you with an AI that actually reads your training data, RPE trends and outside-the-gym activity.",
      },
      { name: "theme-color", content: "#111214" },
      { property: "og:title", content: "Loadline — AI strength coach & workout tracker" },
      {
        property: "og:description",
        content: "A workout tracker where the AI coach knows your history, not just a chat window.",
      },
